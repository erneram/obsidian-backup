...
🟡 RESUELTO: Task 1 edge "tenant eliminado → fallback a default". La rama `else` de main.ts ahora resetea `activeBranding.value = null` tras limpiar cache → LoginPage cae a "Kairos Aid" de inmediato. ✅
